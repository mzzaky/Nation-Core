        ...
        public void open(Player player, Nation nation) {
                ...
                if (!isCaliph && !isShura && !isScholar && !player.hasPermission("nation.admin")) {
                        MessageUtils.send(player,
                                        "§cOnly the Caliph, Shura Council, and State Scholars may enter the Caliphate Court.");
                        return;
                }
                ...
                if (!isCaliph) {
                        announcementLore.add("§8▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬");
                        announcementLore.add("§cOnly the Caliph can use this.");
